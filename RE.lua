...
CreateButton(tSpy, "SPYNOTE-EVENT", Color3.fromRGB(180, 40, 40), function()
    ShowNotification("Loading SPYNOTE-EVENT...", false)
    loadstring(game:HttpGet("https://raw.githubusercontent.com/sh4d0w-br0ker/trench-war-script/refs/heads/main/rspy.lua", true))()
end)
