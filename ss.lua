...
-- ЧЕРНАЯ ДЫРА ДЛЯ VOID ТЕМЫ
local BlackHole = Instance.new("Frame")
BlackHole.Size = UDim2.new(0, 200, 0, 200)
BlackHole.Position = UDim2.new(0.5, -100, 0.5, -100)
...
local BlackHoleCorner = Instance.new("UICorner", BlackHole)
BlackHoleCorner.CornerRadius = UDim.new(1, 0)

local BlackHoleGlow = Instance.new("Frame")
BlackHoleGlow.Size = UDim2.new(0, 220, 0, 220)
BlackHoleGlow.Position = UDim2.new(0.5, -110, 0.5, -110)
BlackHoleGlow.BackgroundColor3 = Color3.fromRGB(80, 40, 20)
BlackHoleGlow.BackgroundTransparency = 1
BlackHoleGlow.BorderSizePixel = 0
BlackHoleGlow.Parent = MainFrame

local BlackHoleGlowCorner = Instance.new("UICorner", BlackHoleGlow)
BlackHoleGlowCorner.CornerRadius = UDim.new(1, 0)
...
local function SetVoidTheme(enabled)
    if enabled then
        ...
        BlackHole.BackgroundTransparency = 0.85
        BlackHoleGlow.BackgroundTransparency = 0.7
        StarsContainer.BackgroundTransparency = 0
        for _, star in pairs(stars) do
            star.BackgroundTransparency = 0.2
        end
        local bhTween = TweenService:Create(BlackHole, TweenInfo.new(2, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {Size = UDim2.new(0, 250, 0, 250), Position = UDim2.new(0.5, -125, 0.5, -125)})
        bhTween:Play()
        local glowTween = TweenService:Create(BlackHoleGlow, TweenInfo.new(2, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {Size = UDim2.new(0, 270, 0, 270), Position = UDim2.new(0.5, -135, 0.5, -135)})
        glowTween:Play()
    else
        BlackHole.BackgroundTransparency = 1
        BlackHoleGlow.BackgroundTransparency = 1
