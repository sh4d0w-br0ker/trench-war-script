...
local EspStates = {Rush = false, Eyes = false, Door = false, Key = false, Item = false, LockBox = false, UnLockBox = false, Chest = false, Book = false, Lever = false, PlayerEsp = false, SpeedBoost = false, Figura = false, Ambush = false, ItemDrop = false}
...
if EspStates.Ambush then
    ...
    -- ESP Door (ИСПРАВЛЕНО: показывает номер последней комнаты)
    ...
    -- ESP Lever (ИСПРАВЛЕНО: подсвечивает ВСЕ рычаги)
