...
CreateButton(tMisc, "Open Basement", Color3.fromRGB(100, 80, 200), function()
    ...
    -- Телепортируем
    if char and char:FindFirstChild("HumanoidRootPart") then
        char.HumanoidRootPart.CFrame = CFrame.new(27.9161663, 3.56029963, -187.769989, -0.0267044585, -0.00717567047, -0.999617636, 0.000546747586, 0.999973953, -0.00719283475, 0.999643207, -0.000738619303, -0.026699841)
    end
