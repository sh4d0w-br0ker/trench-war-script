...
local FiftyDoorPage = Instance.new("Frame")
FiftyDoorPage.Size = UDim2.new(1, 0, 1, 0)
FiftyDoorPage.BackgroundTransparency = 1
FiftyDoorPage.Visible = false
FiftyDoorPage.Parent = ContentFrame

local HundredDoorPage = Instance.new("Frame")
HundredDoorPage.Size = UDim2.new(1, 0, 1, 0)
HundredDoorPage.BackgroundTransparency = 1
HundredDoorPage.Visible = false
HundredDoorPage.Parent = ContentFrame

local ExploitPage = Instance.new("Frame")
ExploitPage.Size = UDim2.new(1, 0, 1, 0)
ExploitPage.BackgroundTransparency = 1
ExploitPage.Visible = false
ExploitPage.Parent = ContentFrame
...
local FiftyDoorTabBtn = Instance.new("TextButton")
FiftyDoorTabBtn.Size = UDim2.new(1, 0, 0, 40)
FiftyDoorTabBtn.Position = UDim2.new(0, 0, 0, 160)
FiftyDoorTabBtn.Text = "50Door"
FiftyDoorTabBtn.TextColor3 = Color3.fromRGB(150, 150, 150)
FiftyDoorTabBtn.Font = Enum.Font.SourceSansBold
FiftyDoorTabBtn.TextSize = 16
FiftyDoorTabBtn.BackgroundTransparency = 1
FiftyDoorTabBtn.BorderSizePixel = 0
FiftyDoorTabBtn.Parent = Sidebar

local HundredDoorTabBtn = Instance.new("TextButton")
HundredDoorTabBtn.Size = UDim2.new(1, 0, 0, 40)
HundredDoorTabBtn.Position = UDim2.new(0, 0, 0, 200)
HundredDoorTabBtn.Text = "100Door"
HundredDoorTabBtn.TextColor3 = Color3.fromRGB(150, 150, 150)
HundredDoorTabBtn.Font = Enum.Font.SourceSansBold
HundredDoorTabBtn.TextSize = 16
HundredDoorTabBtn.BackgroundTransparency = 1
HundredDoorTabBtn.BorderSizePixel = 0
HundredDoorTabBtn.Parent = Sidebar

local ExploitTabBtn = Instance.new("TextButton")
ExploitTabBtn.Size = UDim2.new(1, 0, 0, 40)
ExploitTabBtn.Position = UDim2.new(0, 0, 0, 240)
ExploitTabBtn.Text = "exploit"
ExploitTabBtn.TextColor3 = Color3.fromRGB(150, 150, 150)
ExploitTabBtn.Font = Enum.Font.SourceSansBold
ExploitTabBtn.TextSize = 16
ExploitTabBtn.BackgroundTransparency = 1
ExploitTabBtn.BorderSizePixel = 0
ExploitTabBtn.Parent = Sidebar
...
local function switchTab(activePage, activeBtn)
    ...
    FiftyDoorPage.Visible = (activePage == FiftyDoorPage)
    HundredDoorPage.Visible = (activePage == HundredDoorPage)
    ExploitPage.Visible = (activePage == ExploitPage)

    local buttons = {InfoTabBtn, EspTabBtn, MonsterTabBtn, PlayerTabBtn, FiftyDoorTabBtn, HundredDoorTabBtn, ExploitTabBtn}
...
FiftyDoorTabBtn.MouseButton1Click:Connect(function() switchTab(FiftyDoorPage, FiftyDoorTabBtn) end)
HundredDoorTabBtn.MouseButton1Click:Connect(function() switchTab(HundredDoorPage, HundredDoorTabBtn) end)
ExploitTabBtn.MouseButton1Click:Connect(function() switchTab(ExploitPage, ExploitTabBtn) end)
...
local EspStates = {
    Rush = false, Eyes = false, Door = false, Key = false, Item = false, LockBox = false, UnLockBox = false,
    Chest = false, Book = false, Lever = false, PlayerEsp = false, SpeedBoost = false, Figura = false,
    Ambush = false, ItemDrop = false, Figura50 = false, Book50 = false, Figura100 = false, LiveBreaker = false,
    Key100 = false, Fullbright = false,
    Wardrobe = false, Bed = false, A120 = false, A60 = false, RushHard = false, Seek = false
}
...
createToggle("Esp Lever off/on", UDim2.new(0, 20, 0, 320), "Lever", EspPage)
createToggle("Esp ItemDrop off/on", UDim2.new(0, 20, 0, 370), "ItemDrop", EspPage)
createToggle("Esp Wardrobe off/on", UDim2.new(0, 20, 0, 420), "Wardrobe", EspPage)
createToggle("Esp Bed off/on", UDim2.new(0, 20, 0, 470), "Bed", EspPage)
...
createToggle("Esp Ambush off/on", UDim2.new(0, 20, 0, 170), "Ambush", MonsterPage)
createToggle("Esp A120 off/on", UDim2.new(0, 20, 0, 220), "A120", MonsterPage)
createToggle("Esp A60 off/on", UDim2.new(0, 20, 0, 270), "A60", MonsterPage)
createToggle("Esp Rush-Hard off/on", UDim2.new(0, 20, 0, 320), "RushHard", MonsterPage)
createToggle("Esp Seek off/on", UDim2.new(0, 20, 0, 370), "Seek", MonsterPage)
...
createToggle("Fullbright off/on", UDim2.new(0, 20, 0, 120), "Fullbright", PlayerPage)

-- Вкладка 50Door
createToggle("Esp Figure off/on", UDim2.new(0, 20, 0, 20), "Figura50", FiftyDoorPage)
createToggle("Esp book off/on", UDim2.new(0, 20, 0, 70), "Book50", FiftyDoorPage)

-- Вкладка 100Door
createToggle("Esp Figure off/on", UDim2.new(0, 20, 0, 20), "Figura100", HundredDoorPage)
createToggle("Esp LiveBreaker off/on", UDim2.new(0, 20, 0, 70), "LiveBreaker", HundredDoorPage)
createToggle("Esp key100 off/on", UDim2.new(0, 20, 0, 120), "Key100", HundredDoorPage)

-- Вкладка Exploit (пока пустая)
local ExploitText = Instance.new("TextLabel")
ExploitText.Size = UDim2.new(1, -40, 0, 50)
ExploitText.Position = UDim2.new(0, 20, 0, 20)
ExploitText.Text = "Empty"
ExploitText.TextColor3 = Color3.fromRGB(150, 150, 150)
ExploitText.TextSize = 16
ExploitText.Font = Enum.Font.SourceSans
ExploitText.BackgroundTransparency = 1
ExploitText.Parent = ExploitPage
...
local activeBooks = {}
local activePlayers = {}
local activeItemDrops = {}
local activeLiveBreakers = {}
local activeKeys100 = {}
...
-- Distance Indicator for Seek
local SeekDistanceText = Instance.new("TextLabel")
SeekDistanceText.Size = UDim2.new(0, 200, 0, 30)
SeekDistanceText.Position = UDim2.new(0.5, -100, 1, -40)
SeekDistanceText.BackgroundTransparency = 1
SeekDistanceText.TextColor3 = Color3.fromRGB(255, 255, 255)
SeekDistanceText.TextSize = 14
SeekDistanceText.Font = Enum.Font.SourceSansBold
SeekDistanceText.Text = "Seek: N/A"
SeekDistanceText.Parent = LocalPlayer.PlayerGui or VoidHub
...
RunService.Heartbeat:Connect(function()
    ...
    -- Distance Indicator for Seek
    local seekFigure = workspace:FindFirstChild("SeekMoving") and workspace.SeekMoving:FindFirstChild("Figure")
    if seekFigure and seekFigure:IsA("BasePart") then
        local dist = getDistance(seekFigure)
        SeekDistanceText.Text = "Seek: " .. tostring(dist) .. " studs"
    else
        SeekDistanceText.Text = "Seek: N/A"
    end
    ...
    -- ESP Figura50 (50Door Page)
    if EspStates.Figura50 then
        local currentRooms = workspace:FindFirstChild("CurrentRooms")
        local hitbox = nil
        ...
        if hitbox then
            updateESP("Figura50", hitbox, "Figure", Color3.fromRGB(255, 0, 0), true)
        else
            updateESP("Figura50", nil, "", Color3.fromRGB(255, 0, 0), false)
        end
    else
        updateESP("Figura50", nil, "", Color3.fromRGB(255, 0, 0), false)
    end

    -- ESP Figura100 (100Door Page)
    if EspStates.Figura100 then
        local currentRooms = workspace:FindFirstChild("CurrentRooms")
        local hitbox = nil
        ...
        if hitbox then
            updateESP("Figura100", hitbox, "Figure", Color3.fromRGB(255, 0, 0), true)
        else
            updateESP("Figura100", nil, "", Color3.fromRGB(255, 0, 0), false)
        end
    else
        updateESP("Figura100", nil, "", Color3.fromRGB(255, 0, 0), false)
    end
    ...
    if EspStates.Ambush then
        ...
        local ambushObject = nil

        if ambushMoving then
            ambushObject = ambushMoving:FindFirstChild("RushNew") or ambushMoving:FindFirstChild("RushNow")
        end
    ...
    -- ESP A120
    if EspStates.A120 then
        local a120 = workspace:FindFirstChild("A120")
        if a120 then
            local mainPart = a120:FindFirstChild("Main")
            if mainPart then
                updateESP("A120", mainPart, "A120", Color3.fromRGB(255, 0, 0), true)
            else
                updateESP("A120", a120, "A120", Color3.fromRGB(255, 0, 0), true)
            end
        else
            updateESP("A120", nil, "", Color3.fromRGB(255, 0, 0), false)
        end
    else
        updateESP("A120", nil, "", Color3.fromRGB(255, 0, 0), false)
    end
    ...
    -- ESP A60
    if EspStates.A60 then
        local a60 = workspace:FindFirstChild("A60")
        if a60 then
            local mainPart = a60:FindFirstChild("Main")
            if mainPart then
                updateESP("A60", mainPart, "A60", Color3.fromRGB(255, 0, 0), true)
            else
                updateESP("A60", a60, "A60", Color3.fromRGB(255, 0, 0), true)
            end
        else
            updateESP("A60", nil, "", Color3.fromRGB(255, 0, 0), false)
        end
    else
        updateESP("A60", nil, "", Color3.fromRGB(255, 0, 0), false)
    end
    ...
    -- ESP Rush-Hard
    if EspStates.RushHard then
        local rushMoving = workspace:FindFirstChild("RushMoving")
        if rushMoving then
            local childToHighlight = nil
            for _, child in pairs(rushMoving:GetChildren()) do
                if child:IsA("BasePart") then
                    childToHighlight = child
                    break
                end
            end
            if childToHighlight then
                updateESP("RushHard", childToHighlight, childToHighlight.Name, Color3.fromRGB(255, 0, 0), true)
            else
                updateESP("RushHard", nil, "", Color3.fromRGB(255, 0, 0), false)
            end
        else
            updateESP("RushHard", nil, "", Color3.fromRGB(255, 0, 0), false)
        end
    ...
    -- ESP Seek
    if EspStates.Seek then
        local seekMoving = workspace:FindFirstChild("SeekMoving")
        if seekMoving then
            local figure = seekMoving:FindFirstChild("Figure")
            if figure then
                updateESP("Seek", figure, "Seek", Color3.fromRGB(255, 0, 0), true)
            else
                updateESP("Seek", nil, "", Color3.fromRGB(255, 0, 0), false)
            end
        else
            updateESP("Seek", nil, "", Color3.fromRGB(255, 0, 0), false)
        end
    ...
    -- ESP Wardrobe
    if EspStates.Wardrobe and currentRooms then
        for _, room in pairs(currentRooms:GetChildren()) do
            local assets = room:FindFirstChild("Assets")
            if assets then
                local wardrobe = assets:FindFirstChild("Wardrobe")
                if wardrobe then
                    local wood = wardrobe:FindFirstChild("Wood")
                    if wood and wood:IsA("BasePart") then
                        local tag = "Wardrobe_" .. room.Name .. "_" .. wood:GetDebugId()
                        updateESP(tag, wood, "Wardrobe", Color3.fromRGB(0, 200, 255), true)
                    end
                end
            end
        end
        -- Cleanup for Wardrobe
        for k, v in pairs(activeHighlights) do
            if type(k) == "string" and string.sub(k, 1, 9) == "Wardrobe_" then
                if not v or not v.Parent or not v.Parent:IsA("BasePart") then
    ...
    -- ESP Bed
    if EspStates.Bed and currentRooms then
        for _, room in pairs(currentRooms:GetChildren()) do
            local assets = room:FindFirstChild("Assets")
            if assets then
                local bed = assets:FindFirstChild("Bed")
                if bed then
                    local main = bed:FindFirstChild("Main")
                    if main and main:IsA("BasePart") then
                        local tag = "Bed_" .. room.Name .. "_" .. main:GetDebugId()
                        updateESP(tag, main, "Bed", Color3.fromRGB(0, 200, 255), true)
                    end
                end
            end
        end
        for k, v in pairs(activeHighlights) do
            if type(k) == "string" and string.sub(k, 1, 4) == "Bed_" then
                if not v or not v.Parent or not v.Parent:IsA("BasePart") then
                    if v then v:Destroy() end
                    activeHighlights[k] = nil
                end
    ...
    -- ESP ItemDrop
    if EspStates.ItemDrop then
        local dropsFolder = workspace:FindFirstChild("Drops")
        local currentValid = {}

        if dropsFolder then
            for _, dropObj in pairs(dropsFolder:GetChildren()) do
                local itemDropPickup = dropObj:FindFirstChild("ItemDropPickup")
                if itemDropPickup then
                    local uniqueKey = dropObj.Name .. "_" .. itemDropPickup:GetDebugId()
                    currentValid[uniqueKey] = true

                    if not activeItemDrops[uniqueKey] then
                        local folder = Instance.new("Folder")
                        folder.Name = "ItemDropESP_" .. dropObj.Name

                        local highlight = Instance.new("Highlight")
                        highlight.FillColor = Color3.fromRGB(0, 255, 0)
                        highlight.FillTransparency = 0.5
                        highlight.OutlineColor = Color3.new(1, 1, 1)
                        highlight.Adornee = itemDropPickup
                        highlight.Parent = folder
                        ...
                        folder.Parent = itemDropPickup
                        activeItemDrops[uniqueKey] = folder
                    end

                    local f = activeItemDrops[uniqueKey]
                    local label = f:FindFirstChildOfClass("BillboardGui"):FindFirstChildOfClass("TextLabel")
                    if label then
                        label.Text = dropObj.Name .. "\n[studs: " .. tostring(getDistance(itemDropPickup)) .. "]"
                    end
                end
            end
        end

        for k, f in pairs(activeItemDrops) do
            if not currentValid[k] then
                f:Destroy()
                activeItemDrops[k] = nil
            end
        end
    else
        clearCache(activeItemDrops)
    end
    ...
    if EspStates.Door and pLastRoom then
        ...
        if realDoor then
            updateESP("Door", realDoor, "Door: " .. tostring(lastRoom.num), Color3.fromRGB(0, 255, 0), true)
        else
            local doorObject = pLastRoom.obj:FindFirstChild("Door") or pLastRoom.obj
            updateESP("Door", doorObject, "Door: " .. tostring(lastRoom.num), Color3.fromRGB(0, 255, 0), true)
        end
    else
...
if EspStates.LiveBreaker then
    ...
    if EspStates.Key100 then
        ...
        if currentRooms then
            local room100 = currentRooms:FindFirstChild("100")
            if room100 then
                local assets = room100:FindFirstChild("Assets")
                if assets then
                    local electricalKey = assets:FindFirstChild("ElectricalKeyObtain")
                    if electricalKey then
                        keyObject = electricalKey:FindFirstChild("Hitbox")
                    end
                end
            end
        end
        if keyObject then
            updateESP("Key100", keyObject, "Key100", Color3.fromRGB(0, 200, 255), true)
        else
        ...
        for _, room in pairs(currentRooms:GetChildren()) do
            ...
            if assets then
                ...
                if lfg and lfg:FindFirstChild("Main") then
                    table.insert(leversFound, lfg.Main)
                end
            end
        end

        for idx, lever in ipairs(leversFound) do
            updateESP("Lever_" .. idx, lever, "Lever", Color3.fromRGB(135, 206, 250), true)
        end

        for k, v in pairs(activeHighlights) do
            if type(k) == "string" and string.sub(k, 1, 6) == "Lever_" then
                local stillExists = false
                for _, lever in ipairs(leversFound) do
                    if v and v.Parent == lever then
                        stillExists = true
                        break
                    end
                end
    ...
    if EspStates.Book50 and currentRooms then
