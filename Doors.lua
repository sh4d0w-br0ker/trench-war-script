...
local EspStates = {Rush = false, Eyes = false, Door = false, Key = false, Item = false, LockBox = false, UnLockBox = false, Chest = false, Book = false, Lever = false, PlayerEsp = false, SpeedBoost = false, Figura = false, Ambush = false, ItemDrop = false, Figura50 = false, Book50 = false, Figura100 = false, LiveBreaker = false, Key100 = false, Fullbright = false}
