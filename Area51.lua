...
MainFrame.Size = UDim2.new(0, 350, 0, 400) -- Было 220, 280 -> стало 350, 400
...
-- ШАПКА (тоже увеличена)
TitleBar.Name = "TitleBar"
TitleBar.Parent = MainFrame
TitleBar.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
TitleBar.Size = UDim2.new(1, 0, 0, 40) -- Было 35, стало 40
...
TitleLabel.TextSize = 16 -- Было 14, стало 16
TitleLabel.TextXAlignment = Enum.TextXAlignment.Left

-- КНОПКА СВОРАЧИВАНИЯ
ToggleBtn.Parent = TitleBar
ToggleBtn.Text = "_"
ToggleBtn.Size = UDim2.new(0, 35, 0, 30) -- Было 30,25 -> стало 35,30
ToggleBtn.Position = UDim2.new(1, -40, 0, 5) -- Было -35, стало -40
...
-- БОКОВАЯ ПАНЕЛЬ И КОНТЕЙНЕР (увеличены)
Sidebar.Name = "Sidebar"
Sidebar.Parent = MainFrame
Sidebar.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
Sidebar.Position = UDim2.new(0, 5, 0, 45) -- Было 40, стало 45
Sidebar.Size = UDim2.new(0, 70, 1, -50) -- Было 60, -45 -> стало 70, -50
...
Container.Position = UDim2.new(0, 80, 0, 45) -- Было 70,40 -> стало 80,45
Container.Size = UDim2.new(1, -85, 1, -50) -- Было -75,-45 -> стало -85,-50
...
local function createTab(name)
    ...
    scroll.ScrollBarThickness = 4 -- Было 2, стало 4
    scroll.ScrollBarImageColor3 = Color3.fromRGB(100, 100, 100)
    local layout = Instance.new("UIListLayout")
    layout.Parent = scroll
    layout.Padding = UDim.new(0, 8) -- Было 5, стало 8
    layout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
        scroll.CanvasSize = UDim2.new(0, 0, 0, layout.AbsoluteContentSize.Y + 10)
    end)
    local tabBtn = Instance.new("TextButton")
    tabBtn.Parent = Sidebar
    tabBtn.Size = UDim2.new(0, 60, 0, 35) -- Было 50,30 -> стало 60,35
    tabBtn.Text = name
    tabBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
    tabBtn.TextColor3 = Color3.fromRGB(200, 200, 200)
    tabBtn.Font = Enum.Font.Gotham
    tabBtn.TextSize = 12 -- Было 10, стало 12
    local c = Instance.new("UICorner")
    c.CornerRadius = UDim.new(0, 6) -- Было 4, стало 6
    c.Parent = tabBtn
...
local function addBtn(parent, txt, callback, clr)
    ...
    b.Parent = parent
    b.Size = UDim2.new(1, 0, 0, 35) -- Было 30, стало 35
    b.Text = txt
    b.BackgroundColor3 = clr or Color3.fromRGB(50, 50, 50)
    b.TextColor3 = Color3.new(1, 1, 1)
    b.Font = Enum.Font.Gotham
    b.TextSize = 12 -- Было 10, стало 12
    local c = Instance.new("UICorner")
    c.CornerRadius = UDim.new(0, 6) -- Было 4, стало 6
    c.Parent = b
...
local function showNotification(text, color)
    ...
    notification.Position = UDim2.new(0, 0, 0, 140) -- Было 120, стало 140
...
-- Функция для создания поля ввода (увеличена)
local function createInput(parent, placeholder, defaultValue, callback, isKillersTab)
    local frame = Instance.new("Frame")
    frame.Parent = parent
    frame.Size = UDim2.new(1, 0, 0, 45) -- Было 40, стало 45
    frame.BackgroundTransparency = 1
    
    local label = Instance.new("TextLabel")
    label.Parent = frame
    label.Size = UDim2.new(1, 0, 0, 18) -- Было 15, стало 18
    label.Text = placeholder
    label.TextColor3 = Color3.new(1, 1, 1)
    label.BackgroundTransparency = 1
    label.Font = Enum.Font.Gotham
    label.TextSize = 13 -- Было 12, стало 13
    label.TextXAlignment = Enum.TextXAlignment.Left
    
    local box = Instance.new("TextBox")
    box.Parent = frame
    box.Position = UDim2.new(0, 0, 0, 22) -- Было 18, стало 22
    box.Size = UDim2.new(0.7, 0, 0, 23) -- Было 20, стало 23
    box.Text = tostring(defaultValue)
    box.PlaceholderText = "Введите ник"
    box.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
    box.TextColor3 = Color3.new(1, 1, 1)
    box.Font = Enum.Font.Gotham
    box.TextSize = 13 -- Было 12, стало 13
    box.ClearTextOnFocus = false
    
    local boxCorner = Instance.new("UICorner")
    boxCorner.CornerRadius = UDim.new(0, 6) -- Было 4, стало 6
    boxCorner.Parent = box
    
    if isKillersTab then
        local killBtn = Instance.new("TextButton")
        killBtn.Parent = frame
        killBtn.Position = UDim2.new(0.75, 0, 0, 22) -- Было 18, стало 22
        killBtn.Size = UDim2.new(0.25, -5, 0, 23) -- Было 20, стало 23
        killBtn.Text = "Kill"
        killBtn.BackgroundColor3 = Color3.fromRGB(150, 0, 0)
        killBtn.TextColor3 = Color3.new(1, 1, 1)
        killBtn.Font = Enum.Font.Gotham
        killBtn.TextSize = 12 -- Было 10, стало 12
        
        local btnCorner = Instance.new("UICorner")
        btnCorner.CornerRadius = UDim.new(0, 6) -- Было 4, стало 6
        ...
        applyBtn.Position = UDim2.new(0.75, 0, 0, 22) -- Было 18, стало 22
        applyBtn.Size = UDim2.new(0.25, -5, 0, 23) -- Было 20, стало 23
        applyBtn.Text = "Применить"
        applyBtn.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
        applyBtn.TextColor3 = Color3.new(1, 1, 1)
        applyBtn.Font = Enum.Font.Gotham
        applyBtn.TextSize = 11 -- Было 10, стало 11
...
local function updateHpEsp(char, isEnemy)
    ...
    if not char:FindFirstChild("HpEsp") then
        ...
        billboard.Size = UDim2.new(0, 90, 0, 30) -- Было 80,25 -> стало 90,30
        billboard.StudsOffset = Vector3.new(0, 3.5, 0) -- Было 3, стало 3.5
        ...
        bgCorner.CornerRadius = UDim.new(0, 6) -- Было 4, стало 6
        bgCorner.Parent = bg
        ...
        hpLabel.TextSize = 16 -- Было 14, стало 16
...
killersTitle.Size = UDim2.new(1, 0, 0, 35) -- Было 30, стало 35
...
killersTitle.TextSize = 18 -- Было 16, стало 18
...
killAllBtn.Size = UDim2.new(1, 0, 0, 45) -- Было 40, стало 45
killAllBtn.Position = UDim2.new(0, 0, 0, 100) -- Было 90, стало 100
...
killAllBtn.TextSize = 16 -- Было 14, стало 16

local killAllCorner = Instance.new("UICorner")
killAllCorner.CornerRadius = UDim.new(0, 8) -- Было 6, стало 8
...
killersInfo.Size = UDim2.new(1, 0, 0, 70) -- Было 60, стало 70
killersInfo.Position = UDim2.new(0, 0, 0, 160) -- Было 140, стало 160
...
killersInfo.TextSize = 12 -- Было 11, стало 12
...
settingsTitle.Size = UDim2.new(1, 0, 0, 35) -- Было 30, стало 35
settingsTitle.Text = "НАСТРОЙКИ ГУИ"
settingsTitle.TextColor3 = Color3.new(1, 1, 1)
settingsTitle.BackgroundTransparency = 1
settingsTitle.Font = Enum.Font.GothamBold
settingsTitle.TextSize = 16 -- Было 14, стало 16

-- Кнопки выбора цвета
local colorFrame = Instance.new("Frame")
colorFrame.Parent = tabSettings
colorFrame.Size = UDim2.new(1, 0, 0, 45) -- Было 35, стало 45
colorFrame.BackgroundTransparency = 1

local standardBtn = Instance.new("TextButton")
standardBtn.Parent = colorFrame
standardBtn.Size = UDim2.new(0.3, -2, 0, 30) -- Было 25, стало 30
...
standardBtn.TextSize = 12 -- Было 10, стало 12
Instance.new("UICorner", standardBtn).CornerRadius = UDim.new(0, 6) -- Было 4, стало 6
...
greenBtn.Size = UDim2.new(0.3, -2, 0, 30) -- Было 25, стало 30
...
greenBtn.TextSize = 12 -- Было 10, стало 12
Instance.new("UICorner", greenBtn).CornerRadius = UDim.new(0, 6) -- Было 4, стало 6
...
redBtn.Size = UDim2.new(0.3, -2, 0, 30) -- Было 25, стало 30
...
redBtn.TextSize = 12 -- Было 10, стало 12
Instance.new("UICorner", redBtn).CornerRadius = UDim.new(0, 6) -- Было 4, стало 6
redBtn.MouseButton1Click:Connect(function() changeGuiColor("red") end)

-- Разделитель
local separator = Instance.new("Frame")
separator.Parent = tabSettings
separator.Size = UDim2.new(1, 0, 0, 2) -- Было 1, стало 2
separator.Position = UDim2.new(0, 0, 0, 50) -- Было 40, стало 50
...
hitboxTitle.Size = UDim2.new(1, 0, 0, 35) -- Было 30, стало 35
hitboxTitle.Position = UDim2.new(0, 0, 0, 60) -- Было 45, стало 60
hitboxTitle.Text = "НАСТРОЙКИ ХИТБОКСА"
hitboxTitle.TextColor3 = Color3.new(1, 1, 1)
hitboxTitle.BackgroundTransparency = 1
hitboxTitle.Font = Enum.Font.GothamBold
hitboxTitle.TextSize = 16 -- Было 14, стало 16
...
createInput(tabSettings, "Размер хитбокса (по умолч. 30):", hitboxSize, function(value)
    ...
    notification.Size = UDim2.new(1, 0, 0, 25) -- Было 20, стало 25
    notification.Position = UDim2.new(0, 0, 0, 140) -- Было 120, стало 140
    notification.Text = "✓ Хитбокс изменен на "..value
    notification.TextColor3 = Color3.fromRGB(0, 255, 0)
    notification.BackgroundTransparency = 1
    notification.Font = Enum.Font.Gotham
    notification.TextSize = 13 -- Было 12, стало 13
...
infoLabel.Size = UDim2.new(1, 0, 0, 45) -- Было 40, стало 45
infoLabel.Position = UDim2.new(0, 0, 0, 170) -- Было 150, стало 170
infoLabel.Text = "Значение по умолчанию: 30\nРекомендуется: 30-50"
infoLabel.TextColor3 = Color3.fromRGB(150, 150, 150)
infoLabel.BackgroundTransparency = 1
infoLabel.Font = Enum.Font.Gotham
infoLabel.TextSize = 11 -- Было 10, стало 11
infoLabel.TextWrapped = true

-- MENU
local l = Instance.new("TextLabel", tabMenu)
l.Size = UDim2.new(1,0,0,45) -- Было 40, стало 45
l.Text = "Created By\nxXram000dieXx"
l.TextColor3, l.BackgroundTransparency, l.Font, l.TextSize = Color3.new(1,1,1), 1, Enum.Font.GothamBold, 14 -- Было 12, стало 14

-- СВОРАЧИВАНИЕ (обновлено под новый размер)
local open = true
