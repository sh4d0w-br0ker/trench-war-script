...
local function createTab(name)
    ...
    tabBtn.Size = UDim2.new(0, 50, 0, 30)
    tabBtn.Text = name
...
standardBtn.Size = UDim2.new(0.3, -2, 0, 25)
...
standardBtn.TextSize = 10
Instance.new("UICorner", standardBtn).CornerRadius = UDim.new(0, 4)
...
greenBtn.Size = UDim2.new(0.3, -2, 0, 25)
...
redBtn.Size = UDim2.new(0.3, -2, 0, 25)
...
hitboxTitle.Position = UDim2.new(0, 0, 0, 45)
...
l.Text = "Created By\nxXram000dieXx"
l.TextColor3, l.BackgroundTransparency, l.Font, l.TextSize = Color3.new(1,1,1), 1, Enum.Font.GothamBold, 12

-- СВОРАЧИВАНИЕ
local open = true
ToggleBtn.MouseButton1Click:Connect(function()
    open = not open
    MainFrame:TweenSize(open and UDim2.new(0, 220, 0, 280) or UDim2.new(0, 220, 0, 35), "Out", "Quart", 0.3, true)
