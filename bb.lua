--[[
	WARNING: Heads up! This script has not been verified by ScriptBlox. Use your own risk!
]]
...
-- Hammer
CreateButton(tWeapons, "Get btool", Color3.fromRGB(30, 80, 40), function()
    game.ReplicatedStorage.RemoteEvents.BasementWeapon:FireServer(true, "btool")
end)

-- Crowbar
CreateButton(tWeapons, "Get Btool", Color3.fromRGB(100, 70, 30), function()
    game.ReplicatedStorage.RemoteEvents.BasementWeapon:FireServer(true, "Btool")
end)

-- Spanner
CreateButton(tWeapons, "Get Btools", Color3.fromRGB(60, 100, 140), function()
    game.ReplicatedStorage.RemoteEvents.BasementWeapon:FireServer(true, "Btools")
end)

-- Pitchfork
CreateButton(tWeapons, "Get btool", Color3.fromRGB(120, 60, 60), function()
    game.ReplicatedStorage.RemoteEvents.BasementWeapon:FireServer(true, "btools")
end)
